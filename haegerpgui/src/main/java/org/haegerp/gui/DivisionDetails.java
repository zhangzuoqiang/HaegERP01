...
@Component
/**
 * Dieses Formular wird die Details einer Division kontrollieren
 *
...
public class DivisionDetails extends javax.swing.JFrame {
    ...
    //Wenn der Benutzer eine neue Division erstellen möchte
    public void setNewMode() {
        divisionDetailsView = new DivisionNewView();
        divisionDetailsView.applyView(this);
    }

    //Wenn der Benutzer eine Division ändern möchte
    public void setEditMode() {
        divisionDetailsView = new DivisionEditView();
        divisionDetailsView.applyView(this);
    }

    //Wenn der Benutzer eine Division ansehen möchte
     ...
     * Änderungsmodus.<br/>
     * Wenn der Benutzer die Felder ändern kann, wird die Division
     * gespeichert.<br/>
     * Diese Betrieb wird bei der Variable 'divisionDetailsView' kontrolliert.
     *
     ...
     * Division wieder zum Formular geladen
     *
     * @param e ActionEvent Werte
     */

...
@Component
/**
 * Dieses Formular wird die Details eines Lieferanten kontrollieren
...
public class SupplierDetails extends javax.swing.JFrame {
    ...
    //Wenn der Benutzer einen neuen Lieferanten erstellen möchte
    public void setNewMode() {
        supplierDetailsView = new SupplierNewView();
        supplierDetailsView.applyView(this);
    }

    //Wenn der Benutzer einen Lieferanten ändern möchte
    public void setEditMode() {
        supplierDetailsView = new SupplierEditView();
        supplierDetailsView.applyView(this);
    }

    //Wenn der Benutzer einen Lieferanten ansehen möchte
     ...
     * Änderungsmodus.<br/>
     * Wenn der Benutzer die Felder ändern kann, wird der Lieferant
     * gespeichert.<br/>
     * Diese Betrieb wird bei der Variable 'supplierDetailsView' kontrolliert.
     *

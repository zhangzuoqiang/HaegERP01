...
@Component
/**
 * Dieses Formular wird die Details eines Kunden kontrollieren
 *
...
public class ClientDetails extends javax.swing.JFrame {
    ...
    //Wenn der Benutzer einen neuen Kunden erstellen möchte
    public void setNewMode() {
        clientDetailsView = new ClientNewView();
        clientDetailsView.applyView(this);
    }

    //Wenn der Benutzer einen Kunden ändern möchte
    public void setEditMode() {
        clientDetailsView = new ClientEditView();
        clientDetailsView.applyView(this);
    }

    //Wenn der Benutzer einen Kunden ansehen möchte
     ...
     * Änderungsmodus.<br/>
     * Wenn der Benutzer die Felder ändern kann, wird der Kunde
     * gespeichert.<br/>
     * Diese Betrieb wird bei der Variable 'clientDetailsView' kontrolliert.
     *
    ...
    /**
     * Wenn der Benutzer nicht die Änderungen speichern möchte, wird der Kunde

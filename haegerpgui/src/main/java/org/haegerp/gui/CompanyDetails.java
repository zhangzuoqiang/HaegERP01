...
@Component
/**
 * Dieses Formular wird die Firma verwalten
 *
...
public class CompanyDetails extends javax.swing.JFrame {
    ...
    //Wenn die Firma die Firma ändern möchte
    public void setEditMode() {
        companyDetailsView = new CompanyEditView();
        companyDetailsView.applyView(this);
    }

    //Wenn die Benutzer die Firma ansehen möchte
     ...
     * Änderungsmodus.<br/>
     * Wenn der Benutzer die Felder ändern kann, wird die Firma
     * gespeichert.<br/>
     ...
     * Firma wieder zum Formular geladen
     *
     * @param e ActionEvent Werte
     */
